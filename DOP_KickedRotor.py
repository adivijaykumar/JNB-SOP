...
for epsilon in [1.0,1.5,2.0,3.0,3.5,4.0]:#[0.001,0.01,0.1,1.0,10.0]:
	N=int(2*J+1)
	N_sq=int(N*N)
	
	#Energy=np.zeros((1,N_sq),dtype=np.complex64)
	#QuasiEnergy=np.zeros((1,N_sq),dtype=np.complex64)
	#Eigenvectors1=np.zeros((N_sq,N_sq),dtype=np.complex64)
	#Eigenvectors2=np.zeros((N_sq,N_sq),dtype=np.complex64)
